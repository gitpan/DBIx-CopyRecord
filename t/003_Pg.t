...
unless (exists $ENV{'CR_PG_DSN'}) {
  plan skip_all => "Set 'CR_PG_DSN' environment variable to run this test";
}

unless (exists $ENV{'CR_PG_USER'}) {
  plan skip_all => "Set 'CR_PG_USER' environment variable to run this test";
}

unless (exists $ENV{'CR_PG_PASS'}) {
  plan skip_all => "Set 'CR_PG_PASS' environment variable to run this test";
}

my $DBD = 'Pg'; #DBD to test
                       
my $DB_USER = $ENV{'CR_PG_USER'};
my $DB_PASS = $ENV{'CR_PG_PASS'};
my $DB_DSN = $ENV{'CR_PG_DSN'};
